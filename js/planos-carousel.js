...
// $(window).resize(function() {
//   if ((screen.width > 500) && (screen.width < 992)) {
//     // Alinhamento dos cirucolos do evewnto
//     var larguraCirculo = $('.eventosContainer').width();
//     console.log(larguraCirculo)
//     $('.eventosContainer').height(larguraCirculo + ($('.eventosContainer').width() * 1.9));
//     $('.eventosContainer').width($('.eventosContainer').height(larguraCirculo));
//
//   }
//
//   if (screen.width < 500) {
//     // Alinhamento dos cirucolos do evewnto para telas muito pequenas
//     var larguraCirculo = $('.eventosContainer').innerWidth();
//     console.log("larguraCirculo")
//     $('.eventosContainer').height(larguraCirculo);
//     $('.eventosContainer').width($('.eventosContainer').height(larguraCirculo));
//
//   }
//
...
// if ((screen.width > 500) && (screen.width < 992)) {
//   // Alinhamento dos cirucolos do evewnto
//   var larguraCirculo = $('.eventosContainer').outerWidth();
//   console.log(larguraCirculo)
//   $('.eventosContainer').height(larguraCirculo);
//   $('.eventosContainer').width(larguraCirculo);
//
// }
//
// if (screen.width < 500) {
//   percentual = screen.width * 0.4;
//   // Alinhamento dos cirucolos do evewnto para telas muito pequenas
//   var larguraCirculo = $('.eventosContainer').outerWidth();
//   console.log(larguraCirculo)
//   $('.eventosContainer').height(larguraCirculo - percentual);
//   $('.eventosContainer').width(larguraCirculo - percentual);
//
// }

// $(window).resize(function() {
//   if (screen.width < 992) {
//     // Alinhamento dos cirucolos do evento
//     var larguraCirculo = $('.eventosContainer').width();
//     console.log(larguraCirculo)
//     $('.eventosContainer').height(larguraCirculo);
//   }
